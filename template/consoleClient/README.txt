...
GET THE LATEST VERSION FROM HERE: https://ci.appveyor.com/project/ORelio/minecraft-console-client/build/artifacts


linked to from here: https://github.com/ORelio/Minecraft-Console-Client/releases
